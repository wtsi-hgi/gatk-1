...
In the M-step we maximize the expectation of log complete-data likelihood with respect to $\vpi$. The log complete data likelihood is given as
...
Maximizing under the constraint $\sum_k \pi_k = 1$ gives us
