...
public class AnnotatedVariantProducer implements Serializable {
    ...
    static Map<String, Object> getAssemblyEvidenceRelatedAnnotations(final Iterable<SimpleChimera> splitAlignmentEvidence) {
        ...
        attributeMap.put(GATKSVVCFConstants.HQ_MAPPINGS,       annotations.stream().filter(annotation -> annotation.minMQ == VariantsDiscoveryFromContigsAlignmentsSparkArgumentCollection.CHIMERIC_ALIGNMENTS_HIGHMQ_THRESHOLD).count());
