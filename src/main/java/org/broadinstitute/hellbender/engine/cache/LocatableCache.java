...
public class LocatableCache<T extends Locatable> {
     ...
     */
    public LocatableCache(final LocatableCacheStrategy<T> strategy) {
    ...
    /**
     * Return statistics about the cache hit rate for debugging
     */
    public String getCacheStatistics() {
        final int totalQueries = getNumCacheHits() + getNumCacheMisses();
        return String.format("Cache hit rate was %.2f%% (%d out of %d total queries)",
